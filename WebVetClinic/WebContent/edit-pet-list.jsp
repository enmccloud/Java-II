...
<meta name="description" content="Vet Clinic List Index Page">
...
<title>Edit Existing Client List</title>
...
<body>
	...
	<form action = "editListDetailsServlet" method="post">
		...
		Pet Name: <input type ="text" name = "listName" value="${listToEdit.petListName}"><br />
